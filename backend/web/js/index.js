...
function startTimer($){
	var today=new Date();var h=today.getHours();var m=today.getMinutes();var s=today.getSeconds();m=m<10?"0"+m:m;s=s<10?"0"+s:s;
	if($("#time").length)
		$("#time").html(h+":"+m+":"+s);
	else{
		$('.layui-nav.layui-nav-tree.beg-navbar').before('<div class="user-box border-bottom"><span id="time">'+h+":"+m+":"+s+'</span></div>');
	}
